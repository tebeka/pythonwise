...
if __name__ == "__main__":
    ...
    which passed the resolution by a vote of 131-130, with 88 parliament members
    absent. The Swedish government called the vote a "mistake," but added that
    it will not influence their position on the matter. The Turkish government
    released a statement saying, "our people and our government reject this
    decision based upon major errors and without foundation," and Prime Minister
    Tayyip Erdogan immediately cancelled a planned visit to Sweden. Despite the
    reaction, Turkey said that the moves did "not correspond to the close
    friendship of our two nations," and they were only recalling their
    ...
    Armenians have been heavily campaigning for the killings to be recognized as
    genocide, and many countries worldwide have done so.
    ...
    year. The Turkish ambassador that was recalled said that the vote would have
    "drastic effects" on the negotiations, and it would have an impact for some
    time.

    The Swedish vote came not long after a similar vote by a US Congressional
    panel, which also approved a resolution with similar terminology, leading to
    the removal of Turkey's ambassador. In that case, the US government has been
    trying to prevent the resolution from going further, in an attempt to limit
